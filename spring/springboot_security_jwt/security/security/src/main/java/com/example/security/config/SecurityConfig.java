...
@EnableGlobalMethodSecurity(securedEnabled = true, prePostEnabled = true)      // secured 어노테이션 활성화 (원하는 메서드 선택), preAuthorize 어노테이션 활성화
// prePostEnable 는 preAuthorize 와 postAuthorize 어노테이션을 활성화해준다.
